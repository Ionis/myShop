<header class="d-flex flex-wrap align-items-center justify-content-center justify-content-md-between py-3 mb-4 border-bottom">
    ...
    <div class="col-md-4 text-end">
        ...
        {if isset($arrUser)}
            ...
            {else}
            <a href="/?controller=user&action=templateAuth" type="button" class="btn btn-outline-primary me-2 btn-sm">Войти</a>
            <a href="/?controller=user&action=templateReg" type="button" class="btn btn-primary btn-sm">Регистрация</a>
        {/if}
    </div>
</header>